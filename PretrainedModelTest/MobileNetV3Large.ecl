/*
About this test:
  Test the usability of Pre-trained Model MobileNetV3Large.
...
class                   probability
tusker	                0.5472314953804016
African_elephant	      0.3541534841060638
Indian_elephant	        0.01210936810821295
*/
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.MobileNetV3Large(weights = "imagenet")'''];
