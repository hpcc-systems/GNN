/*
About this test:
  Test the usability of Pre-trained Model RegNetX064.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/regnet/RegNetX064
  Input shape = (224, 224, 3) 
  
Results:

class                   score
African_elephant	      3.356326580047607
tusker	                2.163609266281128
Indian_elephant	        -1.485133051872253
*/
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.regnet.RegNetX064(weights = "imagenet")'''];
