...
About this test:
  ...
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/resnet_v2/ResNet101V2
  Input shape = (224, 224, 3) 

Results:

class                   probability
African_elephant	0.7400751709938049
tusker	0.2594313323497772
Indian_elephant	0.0004916752805002034
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.resnet_v2.ResNet101V2(weights = "imagenet")'''];
