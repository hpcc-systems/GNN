/*
About this test:
  Test the usability of Pre-trained Model RegNetY320.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/regnet/RegNetY320
  Input shape = (224, 224, 3) 
  
Results:

class                   score
tusker	                0.6531279683113098
African_elephant	      0.248483806848526
Indian_elephant	        -3.687517166137695
*/
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.regnet.RegNetY320(weights = "imagenet")'''];
