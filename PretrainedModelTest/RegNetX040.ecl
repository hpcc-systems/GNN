/*
About this test:
  Test the usability of Pre-trained Model RegNetX040.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/regnet/RegNetX040
  Input shape = (224, 224, 3) 
  
Results:

class                   score
tusker	                4.075882911682129
African_elephant	      3.630982398986816
Indian_elephant	        1.388230443000793
*/
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.regnet.RegNetX040(weights = "imagenet")'''];
