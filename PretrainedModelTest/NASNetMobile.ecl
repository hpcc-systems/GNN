/*
About this test:
  Test the usability of Pre-trained Model NASNetMobile.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/nasnet/NASNetMobile
  Input shape = (224, 224, 3) 
  
Results:

class                   probability
African_elephant	      0.5382847189903259
tusker	                0.3432314395904541
Indian_elephant	        0.02341131865978241
*/
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.nasnet.NASNetMobile(weights = "imagenet")'''];
