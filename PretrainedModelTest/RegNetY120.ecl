/*
About this test:
  Test the usability of Pre-trained Model RegNetY120.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/regnet/RegNetY120
  Input shape = (224, 224, 3) 
  
Results:

class                   score
tusker	                2.222987413406372
African_elephant	      2.192929029464722
Indian_elephant	        -1.775080680847168
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.regnet.RegNetY120(weights = "imagenet")'''];
