/*
About this test:
  Test the usability of Pre-trained Model InceptionResNetV2.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/inception_resnet_v2/InceptionResNetV2
  Input shape = (299, 299, 3) 
  
Results:

class                   probability
tusker	                0.5692148208618164
African_elephant	      0.3252205550670624
Indian_elephant	        0.003985946998000145
*/
...
SET OF REAL hexToNparry(DATA byte_array):= EMBED(Python)
  ...
  I_array = tf.keras.applications.inception_resnet_v2.preprocess_input(I_array)
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.inception_resnet_v2.InceptionResNetV2(weights = "imagenet")'''];
