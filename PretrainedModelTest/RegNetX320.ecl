/*
About this test:
  Test the usability of Pre-trained Model RegNetX320.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/regnet/RegNetX320
  Input shape = (224, 224, 3) 
  
Results:

class                   score
tusker	                2.797254085540771
African_elephant	      2.440820932388306
Indian_elephant	        -1.195971488952637
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.regnet.RegNetX320(weights = "imagenet")'''];
