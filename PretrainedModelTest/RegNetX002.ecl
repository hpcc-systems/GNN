/*
About this test:
  Test the usability of Pre-trained Model RegNetX002.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/regnet/RegNetX002
  Input shape = (224, 224, 3) 
  
Results:

class                   score
African_elephant	      7.394824504852295
tusker	                6.895373821258545
Indian_elephant	        3.416041135787964
*/
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.regnet.RegNetX002(weights = "imagenet")'''];
