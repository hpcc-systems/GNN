/*
About this test:
  Test the usability of Pre-trained Model RegNetY160.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/regnet/RegNetY160
  Input shape = (224, 224, 3) 
  
Results:

class                   score
African_elephant	      1.963338971138
tusker	                0.6258978247642517
Indian_elephant	        -2.980559110641479
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.regnet.RegNetY160(weights = "imagenet")'''];
