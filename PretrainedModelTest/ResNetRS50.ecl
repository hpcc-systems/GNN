/*
About this test:
  Test the usability of Pre-trained Model ResNetRS50.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/resnet_rs/ResNetRS50
  Input shape = (224, 224, 3) 

Results:

class                   probability
tusker	                0.3940568864345551
African_elephant	      0.1544611752033234
Indian_elephant	        0.0271658431738615
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.resnet_rs.ResNetRS50(weights = "imagenet")'''];
