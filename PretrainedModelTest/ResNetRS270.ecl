/*
About this test:
  Test the usability of Pre-trained Model ResNetRS270.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/resnet_rs/ResNetRS270
  Input shape = (224, 224, 3) 

Results:

class                   probability
tusker	                0.6213197112083435
African_elephant	      0.2296619564294815
Indian_elephant	        0.01356464717537165
*/
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.resnet_rs.ResNetRS270(weights = "imagenet")'''];
