/*
About this test:
  Test the usability of Pre-trained Model RegNetX016.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/regnet/RegNetX016
  Input shape = (224, 224, 3) 
  
Results:

class                   score
tusker	                4.786515712738037
African_elephant	      4.65722131729126
Indian_elephant	        0.8958739638328552
*/
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.regnet.RegNetX016(weights = "imagenet")'''];
