/*
About this test:
  Test the usability of Pre-trained Model RegNetX006.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/regnet/RegNetX006
  Input shape = (224, 224, 3) 
  
Results:

class                   score
African_elephant	      4.175625324249268
tusker	                3.583528757095337
Indian_elephant	        1.142752289772034
*/
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.regnet.RegNetX006(weights = "imagenet")'''];
