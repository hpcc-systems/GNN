...
About this test:
  ...
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/resnet_rs/ResNetRS152
  Input shape = (224, 224, 3) 

Results:

class                   probability
tusker	                0.5994042158126831
African_elephant	      0.2694270014762878
Indian_elephant	        0.006519712973386049
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.resnet_rs.ResNetRS152(weights = "imagenet")'''];
