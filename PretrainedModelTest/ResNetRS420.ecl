/*
About this test:
  Test the usability of Pre-trained Model ResNetRS420.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/resnet_rs/ResNetRS420
  Input shape = (224, 224, 3) 

Results:

class                   probability
African_elephant	      0.4900539815425873
tusker	                0.3976803421974182
Indian_elephant	        0.02010920271277428
*/
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.resnet_rs.ResNetRS420(weights = "imagenet")'''];
