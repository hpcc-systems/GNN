/*
About this test:
  Test the usability of Pre-trained Model RegNetY006.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/regnet/RegNetY006
  Input shape = (224, 224, 3) 
  
Results:

class                   score
tusker	                4.69649076461792
African_elephant	      3.820046424865723
Indian_elephant	        1.447339177131653
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.regnet.RegNetY006(weights = "imagenet")'''];
