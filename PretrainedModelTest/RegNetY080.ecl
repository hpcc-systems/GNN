/*
About this test:
  Test the usability of Pre-trained Model RegNetY080.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/regnet/RegNetY080
  Input shape = (224, 224, 3) 
  
Results:

class                   score
African_elephant	      2.989919185638428
tusker	                2.914013862609863
Indian_elephant	        0.0711519792675972
*/
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.regnet.RegNetY080(weights = "imagenet")'''];
