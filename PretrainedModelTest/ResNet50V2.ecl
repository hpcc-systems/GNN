/*
About this test:
  Test the usability of Pre-trained Model ResNet50V2.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/resnet_v2/ResNet50V2
  Input shape = (224, 224, 3) 

Results:

class                   probability
African_elephant	      0.8566305637359619
tusker	                0.1427023410797119
Indian_elephant	        0.0006476989947259426
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.resnet_v2.ResNet50V2(weights = "imagenet")'''];
