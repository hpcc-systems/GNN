/*
About this test:
  Test the usability of Pre-trained Model RegNetY064.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/regnet/RegNetY064
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.regnet.RegNetY002(weights = "imagenet")'''];
