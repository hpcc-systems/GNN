/*
About this test:
  Test the usability of Pre-trained Model RegNetY004.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/regnet/RegNetY004
  Input shape = (224, 224, 3) 
  
Results:

class                   score
tusker	                3.653361797332764
African_elephant	      3.498329639434814
Indian_elephant	        1.565586805343628
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.regnet.RegNetY004(weights = "imagenet")'''];
