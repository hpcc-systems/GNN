/*
About this test:
  Test the usability of Pre-trained Model RegNetY008.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/regnet/RegNetY008
  Input shape = (224, 224, 3) 
  
Results:

class                   score
tusker	                4.458223342895508
African_elephant	      4.225468635559082
Indian_elephant	        2.324331283569336
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.regnet.RegNetY008(weights = "imagenet")'''];
