/*
About this test:
  Test the usability of Pre-trained Model ResNet101V2.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/resnet_v2/ResNet152V2
  Input shape = (224, 224, 3) 

Results:

class                   probability
tusker	                0.5724382400512695
African_elephant	      0.4274871051311493
Indian_elephant	        0.00007472796278307214
...
SET OF REAL hexToNparry(DATA byte_array):= EMBED(Python)
  ...
  I_array = tf.keras.applications.resnet_v2.preprocess_input(I_array)
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.resnet_v2.ResNet152V2(weights = "imagenet")'''];
