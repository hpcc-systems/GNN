/*
About this test:
  Test the usability of Pre-trained Model RegNetX160.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/regnet/RegNetX160
  Input shape = (224, 224, 3) 
  
Results:

class                   score
tusker	                3.437758207321167
African_elephant	      2.704357624053955
Indian_elephant	        -0.6673665046691895
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.regnet.RegNetX160(weights = "imagenet")'''];
