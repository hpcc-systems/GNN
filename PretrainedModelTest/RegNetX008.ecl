/*
About this test:
  Test the usability of Pre-trained Model RegNetX008.
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/regnet/RegNetX008
  Input shape = (224, 224, 3) 
  
Results:

class                   score
African_elephant	      2.908544301986694
tusker	                2.574653148651123
Indian_elephant	        0.5893661975860596
*/
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.regnet.RegNetX008(weights = "imagenet")'''];
