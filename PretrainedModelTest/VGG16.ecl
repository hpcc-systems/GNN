...
About this test:
  ...
  Reference: https://www.tensorflow.org/api_docs/python/tf/keras/applications/vgg16/VGG16
  Input shape = (224, 224, 3) 

Results:

class                   probability
African_elephant	      0.6309871673583984
tusker	                0.353106826543808
Indian_elephant	        0.01583482697606087
...
// load the model
s := GNNI.GetSession(1);
ldef := ['''applications.vgg16.VGG16(weights = "imagenet")'''];
